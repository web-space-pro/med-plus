            ...
            <div class="header__contacts">
                <div class="header__contacts-wrap">
                    ...
                    <div class="cta-icon-block">
                        ...
                        <div class="cta-icon-block--content">
                            <a class="title" href="tel:+7 999 480 44 60">+7 999 480 44 60</a>
                            <span>Работаем круглосуточно</span>
                        </div>
                    </div>
                </div>
            </div>
            <a class="header__order button button--bordered" href="./contacts.html">
...
<div class="mobileMenu">
    <div class="mobileMenu__wrapper">
        ...
        <div class="mobileMenu__cta">
            <a class="button button--bordered" href="./contacts.html">
                Заказать консультацию
            </a>
        </div>
    </div>
