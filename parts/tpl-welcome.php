...
<section class="tplWelcome">
        ...
        <div class="container">
            <div class="tplWelcome__flex">
                ...
                <?php if($show_guaranteeList):
                    include get_stylesheet_directory() . DIRECTORY_SEPARATOR . "g_parts" . DIRECTORY_SEPARATOR ."guarantee-list.php";
                 else: ?>
    ...
    <?php if($show_contact_info)
        include get_stylesheet_directory() . DIRECTORY_SEPARATOR . "g_parts" . DIRECTORY_SEPARATOR ."contact-info.php";
    ?>
    ...
    <?php if($show_metrics):
        include get_stylesheet_directory() . DIRECTORY_SEPARATOR . "g_parts" . DIRECTORY_SEPARATOR ."metrics-list.php";
    else: ?>
