<?php
add_action('wp_enqueue_scripts', 'med_plus_theme_scripts');
add_action('wp_enqueue_scripts', 'med_plus_theme_styles');

add_filter( 'style_loader_src',  'sdt_remove_ver_css_js', 9999, 2 );
add_filter( 'script_loader_src', 'sdt_remove_ver_css_js', 9999, 2 );


function med_plus_theme_scripts()
{
...
function med_plus_theme_styles()
{
	$ver = wp_get_theme()->get( 'Version' );
